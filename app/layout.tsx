...
export const metadata: Metadata = {
  ...
  description: 'BananaSwap is the ultimate cross-chain decentralized exchange. Swap tokens across 40+ blockchains with the best rates, lightning-fast trades, and rock-solid security. Trade on Ethereum, BNB Chain, Polygon, Arbitrum, and more.',
  keywords: [
    'DEX',
  ...
  openGraph: {
    ...
    description: 'The ultimate cross-chain swap experience. Find the best routes for lightning-fast trades on all your favorite networks.',
    images: [
      {
        url: '/og-image.png',
        width: 1200,
