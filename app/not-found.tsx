...
export const metadata: Metadata = {
  ...
  description: 'The page you are looking for could not be found. Return to BananaSwap homepage to continue trading.',
  robots: {
    index: false,
    follow: false,
  },
        ...
        <div className="space-y-4">
          ...
          <div className="text-sm text-gray-500">
            ...
            <div className="mt-2 space-x-4">
              <Link href="/swap" className="text-yellow-400 hover:text-yellow-300">
                Swap Tokens
              </Link>
              <Link href="/tokens" className="text-yellow-400 hover:text-yellow-300">
                View Tokens
              </Link>
